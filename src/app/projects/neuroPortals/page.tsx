          ...
          <section className="grid gap-10 md:grid-cols-2 md:items-center">
            ...
            <Reveal>
              <div className="space-y-4 max-w-xl">
                ...
                <p className="text-sm md:text-base leading-relaxed text-white/90">
                  For the final installation, we built a larger model of our &ldquo;doors&rdquo;—the architectural structure that housed the projections. This made the experience more immersive and deepened the installation&apos;s meditative quality.
                </p>
                <p className="text-sm md:text-base leading-relaxed text-white/90">
