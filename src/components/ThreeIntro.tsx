    ...
    try {
      ...
      loader.load(
        ...
        (e) => {
          ...
          if (onError) onError("Failed to load image texture");
        }
      );
      ...
      console.error('ThreeIntro Error:', err);
      if (onError) onError('Failed to initialize 3D scene');
    }
  }, [imageSrc, onError]);

  return <div ref={mountRef} className="holo-canvas" />;
}